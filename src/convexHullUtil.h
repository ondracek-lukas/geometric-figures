...
/* Can be used for convex hull update, which is not currently implemented:
 * Expands fig with the given vertices in the space generated by fig, returns true if expansion was needed
extern bool convexHullUtilExpand(struct convexFig *fig, struct convexFigList *newVertices);

// Removes faces of fig which have outer vertices in pVertices list, returns their count
extern int convexHullUtilWrongFacesRm(struct convexFig *fig, struct convexFigList *verticess);
*/
